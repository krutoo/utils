...
For example next we will use [MediaQueryListMock](/utils/testing/media-query-list-mock):
...
This example shows that you don't need to use environment that implements `matchMedia`.
