...
The package provides very basic but powerful utilities to implement IoC in your projects.
...
We can use this in the following way. First we need to define our tokens:

```ts title="app/token.ts"
